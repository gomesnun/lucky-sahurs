...
pub const UPDATE_LOG: &[(&str, &str, &[&str])] = &[
    ("v4.0.0", "2026-09-25", &[
        ...
        "Battles: every Verity fights in its own phase. Monsters start as Phase 3, fill a RAGE meter and TRANSFORM into their Monster form for 3 turns with a huge boost.",
