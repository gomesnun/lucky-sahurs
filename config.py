...
try:
    ...
    BUILD_VERSION = "dev"
VERSION = BUILD_VERSION if BUILD_VERSION != "dev" else "v2.0.0"       # o que aparece no menu

# Atualizações automáticas (ver online/updater.py)
# O repositório do GitHub mantém o nome antigo (lucky-sahurs): se um dia o renomeares no GitHub, muda isto também.
